...
<header class="header">
   ...
   <section class="flex">
      ...
      <a href="dashboard.php" class="logo">Administrador</a>

      <form action="search_page.php" method="post" class="search-form">
         <input type="text" name="search" placeholder="buscar aqui..." required maxlength="100">
      ...
      <div class="profile">
         ...
         <a href="../components/admin_logout.php" onclick="return confirm('desea cerrar sesion?');" class="delete-btn">cerrar sesion</a>
         <?php
            }else{
         ?>
...
<div class="side-bar">
   ...
   <nav class="navbar">
      ...
      <a href="contents.php"><i class="fas fa-graduation-cap"></i><span>contenidos</span></a>
