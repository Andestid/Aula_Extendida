...
if(isset($_POST['submit'])){
   ...
   if($select_user->rowCount() > 0){
     ...
     header('location:home.php');
      ...
      $message[] = 'ha ingresado mal su correo o contraseña!';
   }
...
<section class="form-container">
   ...
   <form action="" method="post" enctype="multipart/form-data" class="login">
      ...
      <input type="email" name="email" placeholder="ingrese su correo" maxlength="50" required class="box">
      <p> contraseña <span>*</span></p>
      <input type="password" name="pass" placeholder="ingrese su contraseña" maxlength="20" required class="box">
      <p class="link">¿No tiene una cuenta? <a href="register.php">registrate ahora</a></p>
