...
if(isset($_POST['like_content'])){
   ...
   if($user_id != ''){
      ...
      if($select_likes->rowCount() > 0){
         ...
         $message[] = 'quitar de los que me gustan!';
      }else{
         ...
         $message[] = 'añadir a los que me gustan!';
      }

   }else{
      $message[] = 'inicia sesion primero!';
   }
   ...
   if($user_id != ''){
      ...
      if($select_content->rowCount() > 0){
         ...
         if($select_comment->rowCount() > 0){
            $message[] = 'este comentario ya fue agregado!';
         }else{
...
if(isset($_POST['delete_comment'])){
   ...
   if($verify_comment->rowCount() > 0){
      ...
      $message[] = 'este comentario ya ha sido borrado!';
   }
...
<section class="edit-comment">
   ...
   <form action="" method="post">
      ...
      <textarea name="update_box" class="box" maxlength="1000" required placeholder="ingresa un comentario" cols="30" rows="10"><?= $fetch_edit_comment['comment']; ?></textarea>
      <div class="flex">
         <a href="watch_video.php?get_id=<?= $get_id; ?>" class="inline-option-btn">cancelar edicion</a>
         <input type="submit" value="actualizar ahora" name="update_now" class="inline-btn">
      </div>
   </form>
</section>
<?php
...
<section class="watch-video">
   ...
   <div class="video-details">
      ...
      <form action="" method="post" class="flex">
         ...
         ?>
         <button type="submit" name="like_content"><i class="fas fa-heart"></i><span>me gusto</span></button>
         <?php
         }else{
         ?>
         <button type="submit" name="like_content"><i class="far fa-heart"></i><span>me gusta</span></button>
         <?php
            }
         ?>
      </form>
   ...
   <?php
         ...
         echo '<p class="empty">no se han añadido videos todavia!</p>';
      }
   ?>
...
<section class="comments">
   ...
   <form action="" method="post" class="add-comment">
      ...
      <textarea name="comment_box" required placeholder="escriba su comentario..." maxlength="1000" cols="30" rows="10"></textarea>
   ...
   <div class="show-comments">
      ...
      <div class="box" style="<?php if($fetch_comment['user_id'] == $user_id){echo 'order:-1;';} ?>">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <button type="submit" name="delete_comment" class="inline-delete-btn" onclick="return confirm('borrar este comentario?');">borrar comentario</button>
         </form>
         <?php
         }
         ?>
      ...
      <?php
         ...
         echo '<p class="empty">no se han añadido comentarios todavia!</p>';
      }
      ?>
      </div>
