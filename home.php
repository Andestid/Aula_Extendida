...
<section class="quick-select">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <p>likes totales : <span><?= $total_likes; ?></span></p>
         <a href="likes.php" class="inline-btn">ver likes</a>
         <p>comentarios totales : <span><?= $total_comments; ?></span></p>
      ...
      <div class="box" style="text-align: center;">
         <h3 class="title">por favor inicia sesion o registrate</h3>
      ...
      <div class="box">
         <h3 class="title">categorias principales</h3>
         <div class="flex">
            <a href="search_course.php?"><i class="fas fa-code"></i><span>matematicas</span></a>
      ...
      <div class="box tutor">
         ...
         <a href="admin/register.php" class="inline-btn">comenzemos</a>
      </div>
...
<section class="courses">
   ...
   <div class="box-container">
      ...
      <?php
         ...
         echo '<p class="empty">todavia no hay cursos añadidos!</p>';
      }
      ?>
