...
<section class="teachers">
   ...
   <div class="box-container">
      ...
      <div class="box offer">
         <h3>conviertete en tutor</h3>
         <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Laborum, magnam!</p>
         <a href="admin/register.php" class="inline-btn">empezemos</a>
      </div>
      ...
      <div class="box">
         ...
         <p>videos totaes  : <span><?= $total_contents ?></span></p>
      ...
      <?php
            ...
            echo '<p class="empty">no se encontraron tutores!</p>';
         }
      ?>
