...
<section class="liked-videos">
   ...
   <h1 class="heading">videos que te gustaron</h1>
   ...
   <div class="box">
      ...
      <form action="" method="post" class="flex-btn">
         ...
         <input type="submit" value="quitar" class="inline-delete-btn" name="remove">
      </form>
   </div>
   <?php
            }
         }else{
            echo '<p class="emtpy">no se encontro ningun contenido!</p>';         
         }
      }
   }else{
      echo '<p class="empty">no se han añadido likes todavia!</p>';
   }
   ?>
