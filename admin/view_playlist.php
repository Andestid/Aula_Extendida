...
if(isset($_POST['delete_video'])){
   ...
   if($verify_video->rowCount() > 0){
      ...
      $message[] = 'este video ya fue borrado!';
   }
...
<section class="playlist-details">
   ...
   <h1 class="heading">detalles de la playlist</h1>
   ...
   <div class="row">
      ...
      <div class="details">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <a href="update_playlist.php?get_id=<?= $playlist_id; ?>" class="option-btn">actualizar playlist</a>
            <input type="submit" value="borrar playlist" class="delete-btn" onclick="return confirm('borrar esta playlist?');" name="delete">
         </form>
      </div>
   </div>
   <?php
         ...
         echo '<p class="empty">no se encontraron playlist!</p>';
      }
   ?>
   ...
   ?>
      <div class="box">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <input type="submit" value="borrar" class="delete-btn" onclick="return confirm('borrar este video?');" name="delete_video">
         </form>
         <a href="view_content.php?get_id=<?= $video_id; ?>" class="btn">ver video</a>
      </div>
   <?php
         }
      }else{
         echo '<p class="empty">no se han añadido videos todavia! <a href="add_content.php" class="btn" style="margin-top: 1.5rem;">añadir videos</a></p>';
      }
   ?>
