...
if(isset($_POST['delete_video'])){
   ...
   if($verify_video->rowCount() > 0){
      ...
      $message[] = 'este video ya ha sido borrado!';
   }
...
if(isset($_POST['delete_playlist'])){
   ...
   $message[] = 'playlist borrada!';
      ...
      $message[] = 'esta playlist ya fue borrada!';
   }
}
...
<section class="contents">
   ...
   <?php
         ...
         echo '<p class="empty">no se encontro contenido!</p>';
      }
   }else{
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <input type="submit" value="delete_playlist" class="delete-btn" onclick="return confirm('borrar esta playlist?');" name="delete">
         </form>
      ...
      <?php
         ...
         echo '<p class="empty">no se encontraron playlists!</p>';
      }}else{
         echo '<p class="empty">por favor busca algo!</p>';
      }
      ?>
