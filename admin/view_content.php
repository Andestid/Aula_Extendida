...
if(isset($_POST['delete_comment'])){
   ...
   if($verify_comment->rowCount() > 0){
      ...
      $message[] = 'se borro este comentario!';
   }else{
...
<section class="view-content">
   ...
   <?php
      ...
      echo '<p class="empty">no se ha añadido contenido todavia! <a href="add_content.php" class="btn" style="margin-top: 1.5rem;">añadir videos</a></p>';
   }
