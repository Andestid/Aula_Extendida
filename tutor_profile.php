...
<section class="tutor-profile">
   ...
   <div class="details">
      ...
      <div class="flex">
         <p>playlists totales : <span><?= $total_playlists; ?></span></p>
         <p>videos totales : <span><?= $total_contents; ?></span></p>
...
<section class="courses">
   ...
   <div class="box-container">
      ...
      <?php
         ...
         echo '<p class="empty">no se han añadido cursos todavia!</p>';
      }
      ?>
